...
/* ===========================
   IMAGE DE PROFIL – DEUX NIVEAUX DE PROFONDEUR
   =========================== */

// Image par défaut (depuis ce dossier)
...
if (!empty($_SESSION['utilisateur']['image_profil'])) {
    ...
    // 🔥 Si l'image existe, construire le chemin correct pour 2 niveaux
